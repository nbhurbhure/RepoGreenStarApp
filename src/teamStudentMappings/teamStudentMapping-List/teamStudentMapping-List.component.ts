...
import { TeamStudentMapping } from '../shared/teamStudentMapping.model';
import { ToastrService } from 'ngx-toastr';   

@Component({
  selector: 'app-teamStudentMapping-list',
  templateUrl: './teamStudentMapping-list.component.html',
  styleUrls: ['./teamStudentMapping-list.component.css']
})
